    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="车位介绍" prop="cheweijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.cheweijieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cheweijieshao" label="车位介绍" prop="cheweijieshao">
                    <span v-html="ruleForm.cheweijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.cheweijieshao = this.ruleForm.cheweijieshao.replace(reg,'../../../ssm5tq98/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
